...
"""Usage:
add_entity_linking.py <episode> <path_to_corpora>
"""
...
if __name__ == '__main__':
    ...
    # Friends
    "Friends": {'joey': 'joey_tribbiani', 'chandler': 'chandler_bing', 'phoebe': 
                'phoebe_buffay', 'ross': 'dr_ross_geller', 'rachel': 'rachel_green', 'jasmine': 'jasmine', 
                'paul': 'paul','franny': 'franny', 'marsha': 'marsha', 'carol': 'carol_willick', 'julie':'julie',
                ...
                'sandy': 'sandy', 'dick': 'dick_clark','jay': 'jay_leno', 'nora': 'nora_tyler_bing', 'carl':'carl',
                'ronni': 'ronni', 'roger':'roger', 'kristen': 'kristen','lorraine': 'lorraine', 'monica':'monica_geller',
                'celia': 'celia', 'steve': 'steve', 'nina': 'nina', 'jamie': 'jamie_buchman', 'melanie': 'melanie',
                'fran': 'fran_devanow', 'aunt': 'aunt_iris', 'marcel': 'marcel_the_monkey', 'lydia': 'lydia',
                'luisa': 'luisa', 'samantha': 'samantha', 'tia': 'tia', 'mindy':'mindy', 'ethan': 'ethan',
                
                },
    # BSG
    "BattlestarGalactica" : { 'lee': 'cpt_lee_adama', 'laura': 'president_laura_roslin', 'adar': 'president_richard_adar',
                            ...
                            'aaron': 'aaron_doral', 'boxey': 'boxey', 'mason': 'mason','hotdog': 'lt_brendan_constanza',
                             'cottle': 'dr_cottle', 'zak': 'zak_adama', 'chuckles': 'chuckles', 'hadrian': 'sgt_hadrian',
                             'leoben': 'leoben_conoy', 'conoy': 'leoben_conoy', 'ellen': 'ellen_tigh', 'valerii': 'lt_sharon_valerii',
                             'james': 'james_mcmanus','mcmanus': 'james_mcmanus', 'playa': 'playa_palacios', 'palacios': 'playa_palacios',
                             'sekou': 'sekou_hamilton','hamilton': 'sekou_hamilton', 'wallace': 'wallace_gray',
    ...
    # #### Write new file
    print(f"Writing new alignment file to {DATA_PLUMCOT}/{serie}/")
